...
import FileMenuView from '../../../../../views/apps/messenger/header-bar/menu-bar/menus/file-menu-view.js';
import EditMenuView from '../../../../../views/apps/messenger/header-bar/menu-bar/menus/edit-menu-view.js';
import SelectMenuView from '../../../../../views/apps/messenger/header-bar/menu-bar/menus/select-menu-view.js';
import ViewMenuView from '../../../../../views/apps/messenger/header-bar/menu-bar/menus/view-menu-view.js';
import ShareMenuView from '../../../../../views/apps/messenger/header-bar/menu-bar/menus/share-menu-view.js';
import SearchMenuView from '../../../../../views/apps/messenger/header-bar/menu-bar/menus/search-menu-view.js';
import HelpMenuView from '../../../../../views/apps/messenger/header-bar/menu-bar/menus/help-menu-view.js';
