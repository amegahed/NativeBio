...
class ImageFile extends File
{
	...
	public function getDimensionsAttribute(): ?array {
		...
		if ($this->isLocal()) {
			...
			//
			/*
			$dimensions = $this->getCustomMetaDataValue('dimensions');
	...
	/**
	 * Get this image file's data as a response.
	 *
	 ...
	 * @return Illuminate\Support\Facades\Response
	 */
	public function readExif2(): ?array {
		...
		if ($this->isLocal()) {
			...
			//
			try {
				$command = base_path('') . '/Image-ExifTool-12.10/exiftool ' . $this->rootPath();
	...
	/**
	 * Read this image file's resolution.
	 *
	 * @return array
	 */
