...
import FirstButtonView from '../../../../../views/apps/audio-player/footer-bar/nav-bar/buttons/first-button-view.js';
import PrevButtonView from '../../../../../views/apps/audio-player/footer-bar/nav-bar/buttons/prev-button-view.js';
import NextButtonView from '../../../../../views/apps/audio-player/footer-bar/nav-bar/buttons/next-button-view.js';
import LastButtonView from '../../../../../views/apps/audio-player/footer-bar/nav-bar/buttons/last-button-view.js';
