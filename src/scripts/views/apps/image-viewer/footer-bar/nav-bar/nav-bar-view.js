...
import FirstButtonView from '../../../../../views/apps/image-viewer/footer-bar/nav-bar/buttons/first-button-view.js';
import PrevButtonView from '../../../../../views/apps/image-viewer/footer-bar/nav-bar/buttons/prev-button-view.js';
import NextButtonView from '../../../../../views/apps/image-viewer/footer-bar/nav-bar/buttons/next-button-view.js';
import LastButtonView from '../../../../../views/apps/image-viewer/footer-bar/nav-bar/buttons/last-button-view.js';
import PlayButtonView from '../../../../../views/apps/image-viewer/footer-bar/nav-bar/buttons/play-button-view.js';
...
export default ToolbarView.extend(_.extend({}, Timeable, {
	...
	nextSlide: function() {
		let next = (this.imageNumber % this.numImages) + 1;

		this.app.setImageNumber(next, {

			// callbacks
			//
			success: () => {
				let wraparound = (this.imageNumber == this.numImages);

				// check for wraparound
				//
				if (wraparound && !this.app.preferences.get('slide_looping')) {
	...
	scheduleNext: function() {
		let duration = this.app.preferences.get('slide_duration');
	...
	pause: function() {
		...
		//
		if (this.hasChildView('play') && this.getChildView('play').isSelected()) {
			this.getChildView('play').deselect();
		}
	},
