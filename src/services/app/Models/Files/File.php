...
use App\Models\Files\Item;
use App\Models\Users\User;
use App\Models\Files\Traits\ThumbnailViewable;
use App\Models\Files\Traits\Compressable;
use App\Utilities\Uuids\Guid;
use App\Utilities\Files\UserStorage;
use App\Utilities\Files\Permissions;
...
class File extends Item
{
	...
	public function getModifiedAtAttribute(): ?int {
		...
		if ($this->isLocal()) {
			...
			//
			// return $this->getStorage()->lastModified($this->getPath());
			return null;
		}
	}
