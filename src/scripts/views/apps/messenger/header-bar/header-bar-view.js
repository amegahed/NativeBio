...
import MenuBarView from '../../../../views/apps/messenger/header-bar/menu-bar/menu-bar-view.js';
import SearchBarView from '../../../../views/apps/messenger/header-bar/search-bar/search-bar-view.js';
