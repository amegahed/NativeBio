...
export default SearchBarView.extend({
	...
	showSearchByMessage: function() {
		import(
			'../../../../../views/apps/messenger/header-bar/search-bar/searches/search-by-message-view.js'
	...
	showSearchByNumLikes: function() {
		import(
			'../../../../../views/apps/messenger/header-bar/search-bar/searches/search-by-num-likes-view.js'
	...
	showSearchByNumComments: function() {
		import(
			'../../../../../views/apps/messenger/header-bar/search-bar/searches/search-by-num-comments-view.js'
